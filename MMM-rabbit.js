 ...
 *
 * By neao https://github.com/neao-anderson/MMM-rabbit
 * MIT Licensed.
 */

Module.register("MMM-rabbit", {
    ...
    getDom: function() {
        ...
        switch (true) {
            ...
            case this.ping < this.config.thresholds.strong:
                ...
                if (this.config.showMessage)
                {
                    connStatus.innerHTML = "excellent"
                }
                break;
